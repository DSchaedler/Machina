...
<html>
	...
	<body>
		...
		<div id="info-wrapper">
			<a class="div_link" href="https://www.atlauncher.com/pack/BevosTechPack" target="_blank">
				<img src="images/bevo.png" id="bevo-logo" alt="Bevo's Tech Pack." class="auto-style1">
				<p id="bevo-text">This server runs on the latest version of <u>Bevo's Tech Pack 1.7.10</u></p>
			</a>

			<a target="_blank" href="https://www.atlauncher.com/downloads" class="div_link">
				<img src="images/at.png" id="at-logo" alt="AT Launcher">
				<p id="bevo-text">You will need <u>AT Launcher</u> to run this pack.</p>
			</a>
		</div>
